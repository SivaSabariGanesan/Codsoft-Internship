...
const Contact = () => {
  ...
  const [submitWarning, setSubmitWarning] = useState(false); // Track if user is warned

  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    
    // Show warning if user attempts to submit multiple times quickly
    if (isSubmitting) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setSuccessMessage('Your Message has Sent to Siva Sabari Ganesan Successfully!');
      ...
      setIsSubmitting(false); // Mark form as done submitting
    }
  };
      ...
      <div className="container mx-auto px-4">
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:asivasabariganesan@gmail.com" className="text-white hover:text-primary transition-colors">
        ...
        {submitWarning && (
          <div className="mt-4 text-center text-red-500 font-semibold">
            You have already submitted the form. Please wait for the process to complete.
          </div>
        )}
      </div>
    </section>
